...
public class SuperClassTest extends AbstractTest{
	...
	public void microBenchmark() throws InterruptedException {
		...
		Assert.assertEquals("[LOCAL $r6 FIELD [], LOCAL $r8 FIELD [], LOCAL $r7 FIELD [], LOCAL $r3 FIELD [<de.userstudy.target1.Target: java.lang.String data>], LOCAL $r4 FIELD [<de.userstudy.target1.Target: java.lang.String data>], LOCAL $r5 FIELD []]", currentUnit.getInSet());
		Assert.assertEquals("[LOCAL $r6 FIELD [], LOCAL $r8 FIELD [], LOCAL $r7 FIELD [], LOCAL $r3 FIELD [<de.userstudy.target1.Target: java.lang.String data>], LOCAL $r4 FIELD [<de.userstudy.target1.Target: java.lang.String data>], LOCAL $r5 FIELD []]", currentUnit.getOutSet());
		...
		Assert.assertEquals("[LOCAL $r6 FIELD [], LOCAL $r7 FIELD [], LOCAL $r3 FIELD [<de.userstudy.target1.Target: java.lang.String data>], LOCAL $r4 FIELD [<de.userstudy.target1.Target: java.lang.String data>], LOCAL $r5 FIELD []]", currentUnit.getInSet());
		Assert.assertEquals("[LOCAL $r6 FIELD [], LOCAL $r8 FIELD [], LOCAL $r7 FIELD [], LOCAL $r3 FIELD [<de.userstudy.target1.Target: java.lang.String data>], LOCAL $r4 FIELD [<de.userstudy.target1.Target: java.lang.String data>], LOCAL $r5 FIELD []]", currentUnit.getOutSet());
		
		ea.sendEvent(stepBack);
		currentUnit = dataModel.getCurrentUnit();
		Assert.assertEquals("de.userstudy.target1.Target.main.virtualinvoke r1.<de.userstudy.target1.Target: void overwrite(java.lang.String)>(\"\")", currentUnit.getFullyQualifiedName());
		Assert.assertEquals("[LOCAL $r6 FIELD [], LOCAL $r7 FIELD [], LOCAL $r3 FIELD [<de.userstudy.target1.Target: java.lang.String data>], LOCAL $r4 FIELD [<de.userstudy.target1.Target: java.lang.String data>], LOCAL $r5 FIELD []]", currentUnit.getInSet());
		Assert.assertEquals("[LOCAL $r6 FIELD [], LOCAL $r7 FIELD [], LOCAL $r3 FIELD [<de.userstudy.target1.Target: java.lang.String data>], LOCAL $r4 FIELD [<de.userstudy.target1.Target: java.lang.String data>], LOCAL $r5 FIELD []]", currentUnit.getOutSet());
		...
		Assert.assertEquals("[LOCAL $r6 FIELD [], LOCAL $r3 FIELD [<de.userstudy.target1.Target: java.lang.String data>], LOCAL $r5 FIELD []]", currentUnit.getInSet());
		Assert.assertEquals("[LOCAL $r6 FIELD [], LOCAL $r7 FIELD [], LOCAL $r3 FIELD [<de.userstudy.target1.Target: java.lang.String data>], LOCAL $r5 FIELD []]", currentUnit.getOutSet());
		...
		ea.sendEvent(stepBack);
		currentUnit = dataModel.getCurrentUnit();
		Assert.assertEquals("de.userstudy.target1.Target.main.$r5 = staticinvoke <de.userstudy.target1.Target: java.lang.String getData(de.userstudy.target1.SuperTarget)>(r1)", currentUnit.getFullyQualifiedName());
